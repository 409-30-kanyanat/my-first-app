...
ans3 = st.text_input(
    "ข้อ 1: An `m a _ _ o` a sweet tropical fruit with smooth skin, juicy orange-yellow flesh. 🥭",
    value=st.session_state.ans1_val,
)
ans4 = st.text_input(
    "ข้อ 1: `g _ f t` a present given to someone without asking for money or payment back. 🎁",
    value=st.session_state.ans1_val,
)
